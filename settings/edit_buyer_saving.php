...
else if( mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE `buyer` SET  `buyer_name`='$buyer_name',`buyer_address`='$buyer_address',`country_of_origin`='$country_of_origin',`recording_person_id`='$user_id',`recording_person_name`='$user_name',`recording_time`= NOW() WHERE `buyer_id`= '$buyer_id'";
