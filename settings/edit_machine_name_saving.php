...
else if( mysqli_num_rows($result) < 1)
{
	...
	$update_sql_statement="UPDATE `machine_name` SET `machine_name`='$machine_name',`process_id`='$process_id',`process_name`='$process_name',`recording_person_id`='$user_id',`recording_person_name`='$user_name',`recording_time`=NOW() WHERE  `machine_id`='$machine_id'";
