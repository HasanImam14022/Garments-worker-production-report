...
*/
      ...
      $sql = "select * from `style_name` WHERE `style_id`='$style_id'";
...
<script>
 function sending_data_of_style_name_form_for_saving_in_database()
 {
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'settings/edit_style_name_saving.php',
			 		dataType: 'text',
			 		type: 'post',
...
<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<div class="panel-heading" style="color:#191970;"><b>Edit Style Name</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->

				<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item active" aria-current="page">Home</li>
					    <li class="breadcrumb-item"><a onclick="load_page('settings/style_name.php')">Style Name</a></li>
					    <li class="breadcrumb-item"><a>Edit Style Name</a></li>
					  </ol>
				 </nav>
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="style_name_form" id="style_name_form">
						...
						<div class="form-group form-group-sm" id="form-group_for_style_name">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="style_name" name="style_name" placeholder="Enter Style Name" value="<?php echo $row['style_name']?>" >
									<input type="hidden" class="form-control" id="style_id" name="style_id"  value="<?php echo $row['style_id']?>">
								</div>
						...
						<div class="form-group form-group-sm">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_style_name_form_for_saving_in_database()">Save</button>
