...
function Remove_Value_Of_This_Element(element_name)
{
 ...
 function position_wise_hourly_basis_production_info_line_receiving_using_po()
{
	var po_number = document.getElementById("po_number").value;
    //var po_number = document.getElementById("po_number").value;
 	$.ajax({
        url: 'swing/position_wise_hourly_basis__production_info_po_and_line_receiving.php',
        dataType: 'text',
        type: 'post',
...
function swing_hourly_basis_production_info()
{
    var po_number = document.getElementById("po_number").value;
    ...
    var hour = document.getElementById("hour").value;
 	...
 	$.ajax({
        url: 'swing/position_wise_hourly_basis_production_info_report.php',
        dataType: 'text',
        type: 'post',
        contentType: 'application/x-www-form-urlencoded',
        data: {
       ...
       <div class="form-group form-group-sm" id="form_group_for_hour">
        ...
        <div class="form-group form-group-sm" id="form_group_for_po_number">
           <label class="control-label col-sm-3" for="po_number" style="margin-right:0px; color:#00008B;">PO Number:<span style="color:red"> *</span></label>
             <div class="col-sm-6">
                <select  class="form-control for_auto_complete" id="po_number" name="po_number" onchange="position_wise_hourly_basis_production_info_line_receiving_using_po()">
