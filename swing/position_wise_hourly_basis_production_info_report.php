...
<div class="form-group form-group-sm"  id="database_table">
        <table id="datatable-buttons" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <?php 
                    $s1 = 1;
                    $sql_for_production = "SELECT * FROM `swing_line_and_position_wise_production_info`  where  `date` = '$swing_date' AND `po_number` = '$po_number_value' AND `line_number` = '$line_number_value' AND `hour`='$hour_value'  ";
