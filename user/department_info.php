...
<script>
//  function deleting_data_of_department_info(id)
//  {
// 	 var id = id;
// 	$.ajax({
// 			 		url: 'user/department_info_deleting.php',
// 			 		dataType: 'text',
// 			 		type: 'post',
// 			 		data: {
// 						 department_id = id
             ...
             <tr>
                ...
                <td>
                       ...
                       <span>  </span>
						...
						<!-- <button type="button" id="delete_department" name="delete_department" class="btn btn-danger btn-xs" onClick="deleting_data_of_department_info()">Delete</button> -->
